...
/**
 * This is a debug command for admins. Admins could use to check which generator user is using and could faster find an
 * issue.
 */
    ...
    private static class ImportCommand extends ConfirmableCommand
    {
        ...
        public boolean execute(User user, String label, List<String> args)
        {
            ...
            this.askConfirmation(user,
                ...
                () -> this.<StoneGeneratorAddon>getAddon().getImportManager()
                    .importDatabaseFile(user, this.getWorld(), args.get(0)));
