...
// ---------------------------------------------------------------------
    ...
    private static class GeneratorViewPlayerCommand extends CompositeCommand
    {
         ...
         *
         * @param user the {@link User} who is executing this command.
         * @param alias the label which has been used to execute this command. It can be {@link
         * CompositeCommand#getLabel()} or an alias.
         * @param args the command arguments.
    ...
    /**
     * This class allows to purchase generator directly.
     */
    ...
    /**
     * This class allows to activate/deactivate generator directly.
     */
    private static class GeneratorActivatePlayerCommand extends CompositeCommand
    {
        ...
        {
            this.inheritPermission();
            this.setParametersHelp(Constants.PLAYER_COMMANDS + "activate.parameters");
            this.setDescription(Constants.PLAYER_COMMANDS + "activate.description");
        ...
        public boolean execute(User user, String label, List<String> args)
        {
            if (args.size() == 1 || args.size() == 2)
            {
                ...
                boolean activate = args.size() != 2 || Boolean.parseBoolean(args.get(1));
                ...
                {
                    // always can remove from set.
                    addonManager.deactivateGenerator(user, data, generator);
                }
