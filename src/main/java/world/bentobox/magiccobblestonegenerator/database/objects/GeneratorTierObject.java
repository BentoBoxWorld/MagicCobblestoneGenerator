...
// ---------------------------------------------------------------------
    ...
    /**
     * Method GeneratorTierObject#setRequiredMinIslandLevel sets new value for the requiredMinIslandLevel of this
     * object.
     *
...
// ---------------------------------------------------------------------
    ...
    /**
     * Minecraft has 3 generator types: - cobblestone - stone - basalt
     */
    public enum GeneratorType
    {
         ...
         *
         * @param type Generator type that must be checked. Most likely it is just basic basalt, cobblestone or stone.
         * @return {@code true} if current generator is compatible with given generator type, {@code false} otherwise.
         */
...
// ---------------------------------------------------------------------
    ...
    /**
     * Indicates if current generator is default. Only one generator per type can be default.
     */
    @Expose
